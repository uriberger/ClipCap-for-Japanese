...
venv/bin/python train.py --out_dir ${BASE_DIR}/output/exp_${EXP_IND}_gt --epochs 5 --image_ids_file ${BASE_DIR}/data/image_ids/additional_train_image_ids_${EXP_IND}.json --save_every 5 --load_model_from_path ${BASE_DIR}/output/exp_${EXP_IND}_base/coco_prefix-009.pt
